...
export default function FilterSidebar() {
  ...
  const hasFilters = ['brand_id', 'category_id', 'condition', 'transmission', 'min_price', 'max_price', 'min_year', 'max_year'].some(
    (k) => params.has(k)
  )
        ...
        <div className="space-y-5">
          ...
          <FilterSection label="Brand">
            <select
              ...
              className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-maroon-700/30 focus:border-maroon-700 text-gray-700 bg-white"
            >
          ...
          <FilterSection label="Price (KES)">
            <div className="flex gap-2">
              <input
                ...
                className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-maroon-700/30 focus:border-maroon-700 text-gray-700"
              />
              <input
                type="number"
                placeholder="Max"
